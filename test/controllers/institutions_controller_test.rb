...
class InstitutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create institution" do
    assert_difference('Institution.count') do
      post institutions_url, params: { institution: { Adresse_id: @institution.Adresse_id, Nom: @institution.Nom } }
    end
  ...
  test "should update institution" do
    patch institution_url(@institution), params: { institution: { Adresse_id: @institution.Adresse_id, Nom: @institution.Nom } }
