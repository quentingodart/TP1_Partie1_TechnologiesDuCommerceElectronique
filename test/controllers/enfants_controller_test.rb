...
class EnfantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enfant" do
    assert_difference('Enfant.count') do
      post enfants_url, params: { enfant: { DateNaissance: @enfant.DateNaissance, Nom: @enfant.Nom, Prenom: @enfant.Prenom } }
    end
  ...
  test "should update enfant" do
    patch enfant_url(@enfant), params: { enfant: { DateNaissance: @enfant.DateNaissance, Nom: @enfant.Nom, Prenom: @enfant.Prenom } }
